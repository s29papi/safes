...
export const g7Sepolia = defineChain({
  id: 13746,
  name: 'G7 Sepolia',
  nativeCurrency: { name: 'Testnet Game7 Token', symbol: 'TG7T', decimals: 18 },
  rpcUrls: {
    default: {
  ...
  blockExplorers: {
    default: {
      name: 'TestnetGame7 Explorer',
      url: 'https://testnet.game7.io',
      apiUrl: 'https://testnet.game7.io/api',
    },
  },
  testnet: true,
})
...
const rpcUrl = 'https://testnet-rpc.game7.io'
